...
<script
  ...
  <div class="form-group">
    ...
    <label for="name">Name </label>
        <input type="text" class="form-control" id="name" name="name"  placeholder="Entername" required="required">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" name="confirmpassword" id="exampleInputPassword" placeholder="RetypePassword" required="required">
       ...
       <div class="form-group">        
  <button type="submit" name="submit" id="register" class="btn reg btn-primary btn-block">Register</button>
             </div>       
